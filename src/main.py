...
epoch_loss_save_path = os.path.join(save_dir, 'epoch_loss7e-7.png')
dist_save_path = os.path.join(save_dir, 'mean_dist7e-7.png')
model_save_path = os.path.join(save_dir, 'model7e-7.pth')
