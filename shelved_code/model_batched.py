...
class Conditional_Net(nn.Module):
    ...
    def normalize(self, input_arm_soln):
        return (input_arm_soln - self.input_mean) / self.input_std
...
class Coupling_Layer:
    ...
    def forward(self, 
        ...
        altered_arm_soln = self.conditional_net.normalize(altered_arm_soln)
...
# TODO: implement normalization for only the first layer since all other inputs would already be normalized?